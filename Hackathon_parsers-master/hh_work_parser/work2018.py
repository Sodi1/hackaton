...
mask = 'Энергетика, добыча и переработка сырья'
...
if __name__ == "__main__":
    ...
    sphere_list = list()
    name_list = list()
    static_url = 'https://hh.ru/article/24359'
    ...
    div_node = page_code.xpath('/html/body/div[6]/div/div/div[3]/div/div/div/div[1]/div/div/div[2]/div/div/table/tbody/tr[*]/td[2]/a/text()') # теги с названием
    if not div_node:
    ...
    percent = len(ok)
    print('-----\nПроцентов:', percent)
    with open("percent2018.json", "w") as write_file:
